...
class Page {
    ...
    public function show() {
        ...
        if ($this->url) {
            ...
            $url = rtrim(make_url('/' . $this->url, '', false), $depr) . $depr .
                 '__PAGE__';
        } else {
        ...
        if ($nowCoolPage == 1) {
            ...
            $this->prevPageUrl = str_replace('__PAGE__', $preRow, $url);
        }
        if ($nowCoolPage == $this->coolPages) {
            ...
            $this->nextPageUrl = str_replace('__PAGE__', $nextRow, $url);
        }
        // 1 2 3 4 5
        $linkPage = "";
    ...
    public function show1($withBtnScript =  true) {
        ...
        if($this->url){
            $depr       =   C('URL_PATHINFO_DEPR');
            $url        =   rtrim(make_url('/'.$this->url,'',false),$depr).$depr.'__PAGE__';
        }else{
            if($this->parameter && is_string($this->parameter)) {
                parse_str($this->parameter,$parameter);
            }elseif(is_array($this->parameter)){
