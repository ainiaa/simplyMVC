<?php echo $this->fetch('header.tpl.html'); ?>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="#"> <img alt="Charisma Logo" src="./public/assets/img/logo20.png" class="hidden-xs"/>
                <span>Simple MVC Administrator</span></a>
            ...
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="?m=default&c=default&g=backend&a=loginout">Logout</a></li>
                </ul>
            </div>
