...
<head>
    ...
    <link id="bs-css" href='./public/assets/css/bootstrap-cerulean.min.css' rel="stylesheet">

    <link href='./public/assets/css/charisma-app.css' rel="stylesheet">
    <link href='./public/assets/bower_components/fullcalendar/dist/fullcalendar.css' rel='stylesheet'>
    <link href='./public/assets/bower_components/fullcalendar/dist/fullcalendar.print.css' rel='stylesheet' media='print'>
    <link href='./public/assets/bower_components/chosen/chosen.min.css' rel='stylesheet'>
    <link href='./public/assets/bower_components/colorbox/example3/colorbox.css' rel='stylesheet'>
    <link href='./public/assets/bower_components/responsive-tables/responsive-tables.css' rel='stylesheet'>
    <link href='./public/assets/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css' rel='stylesheet'>
    <link href='./public/assets/css/jquery.noty.css' rel='stylesheet'>
    <link href='./public/assets/css/noty_theme_default.css' rel='stylesheet'>
    <link href='./public/assets/css/elfinder.min.css' rel='stylesheet'>
    <link href='./public/assets/css/elfinder.theme.css' rel='stylesheet'>
    <link href='./public/assets/css/jquery.iphone.toggle.css' rel='stylesheet'>
    <link href='./public/assets/css/uploadify.css' rel='stylesheet'>
    <link href='./public/assets/css/animate.min.css' rel='stylesheet'>

    
    <script src='./public/assets/bower_components/jquery/jquery.min.js'></script>
...
<script src='./public/assets/bower_components/fullcalendar/dist/fullcalendar.min.js'></script>

<script src='./public/assets/js/jquery.dataTables.min.js'></script>


<script src='./public/assets/bower_components/chosen/chosen.jquery.min.js'></script>

<script src='./public/assets/bower_components/colorbox/jquery.colorbox-min.js'></script>

<script src='./public/assets/js/jquery.noty.js'></script>

<script src='./public/assets/bower_components/responsive-tables/responsive-tables.js'></script>

<script src='./public/assets/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js'></script>

<script src='./public/assets/js/jquery.raty.min.js'></script>

<script src='./public/assets/js/jquery.iphone.toggle.js'></script>

<script src='./public/assets/js/jquery.autogrow-textarea.js'></script>

<script src='./public/assets/js/jquery.uploadify-3.1.min.js'></script>

<script src='./public/assets/js/jquery.history.js'></script>
