...
class Api
{
    ...
    {
        $mapping = [
                'category.getList' => 'http://local.category.me/index.php?g=modules&m=category&c=api&a=getList',
                'category.getInfo' => 'http://local.category.me/index.php?g=modules&m=category&c=api&a=getInfo',
        ];
