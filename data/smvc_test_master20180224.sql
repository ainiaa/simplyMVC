...
/*Table structure for table `smvc_article` */

DROP TABLE IF EXISTS `smvc_article`;
...
CREATE TABLE `smvc_article` (
  ...
  `published_time` int(11) DEFAULT NULL COMMENT '发布时间',
...
insert  into `smvc_category`(`id`,`name`,`desc`,`parent_id`,`path`,`type`,`depth`,`order_by`,`created_by`,`created_at`,`updated_by`,`updated_at`) values (1,'root','root',0,',0,','category',1,0,0,1503639487,0,0),(2,'first','first',1,',0,1,','category',2,0,0,1503639509,0,0);
