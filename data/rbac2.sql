...
insert  into `smvc_category`(`id`,`name`,`desc`,`parent_id`,`path`,`depth`,`order_by`,`created_by`,`created_at`,`updated_by`,`updated_at`) values (1,'name','desc',0,'',1,NULL,NULL,NULL,NULL,NULL);

UNLOCK TABLES;

/*Table structure for table `smvc_category_ext_old` */

DROP TABLE IF EXISTS `smvc_category_ext_old`;

CREATE TABLE `smvc_category_ext_old` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `cate_id_taxonomy` (`cate_id`,`taxonomy`),
  KEY `taxonomy` (`taxonomy`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `smvc_category_ext_old` */

LOCK TABLES `smvc_category_ext_old` WRITE;

UNLOCK TABLES;

/*Table structure for table `smvc_category_old` */

DROP TABLE IF EXISTS `smvc_category_old`;

CREATE TABLE `smvc_category_old` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `smvc_category_old` */

LOCK TABLES `smvc_category_old` WRITE;
