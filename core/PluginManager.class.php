 ...
 * 插件机制的实现核心类
 *
 * 直接在需要使用的地方 写code:  $pluginManager->trigger(hook_name,hook_param);
 * 更多的hook  事件驱动编程 请查看 https://github.com/zendframework/zf2/tree/master/library/Zend/EventManager
 * 相关代码
 * @package        STBLOG
...
class PluginManager
{
    ...
    function trigger($hook, $data = '')
    {
        $result = '';
        //查看要实现的钩子，是否在监听数组之中
        if (isset($this->_listeners[$hook]) && is_array($this->_listeners[$hook]) && count(
