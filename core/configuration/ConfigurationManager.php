...
final class ConfigurationManager
{
    ...
    public static function loadConfiguration($namespace, $context, $language, $environment, $name)
    {
        ...
        if (!isset(self::$CONFIG_CACHE[$key])) {
            self::$CONFIG_CACHE[$key] = self::getProvider($name)->loadConfiguration(
                    $namespace,
                    $context,
                    $language,
                    $environment,
    ...
    public static function saveConfiguration(
        ...
        return self::getProvider($name)->saveConfiguration(
                $namespace,
                $context,
                $language,
                $environment,
    ...
    private static function getProvider($name)
    {
        ...
        throw new ConfigurationException('Provider with extension "' . $ext . '" is not registered!', E_USER_ERROR);
    }
