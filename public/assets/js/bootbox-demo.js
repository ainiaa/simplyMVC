...
$(function () {
    ...
    demos.confirm = function (callbackFunc, _target) {
        if (!smvcJSUtil.functionExistsByName(callbackFunc)) {
            callbackFunc = function (result) {
                Example.show("Confirm result: " + result);
            };
        }

        bootbox.confirm("Are you sure??", function(result) {smvcJSUtil.executeFunctionByName(callbackFunc, window, result, _target);});
        //bootbox.confirm("Are you sure??", function(result) {window[callbackFunc](result, _target);});
    };
